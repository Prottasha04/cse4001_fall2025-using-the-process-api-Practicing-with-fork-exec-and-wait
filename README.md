...
/*explanation: the prog starts with x=100. fork() creates a child process that $
of parent, which is 100. then child runs its branch, changes x to 200 and print$
branch runs, changes x to 300. After fork(), the parent and child have separate$
